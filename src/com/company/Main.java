...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (birthday.isBefore(today)){
            // changed to birthday.isBefore(today);
            birthday = birthday.plusYears(1);
            // changed birthday.plusYears(1);
        }
        ...
        // changed ChronoUnit.WEEKS to ChronoUnit.Days
